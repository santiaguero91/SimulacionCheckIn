...
/* router.get('/:id/passengers', checkIn);   boarding_pass   boarding_pass.seat_id  passenger
...
`
    ...
    INNER JOIN seat_type_id 
    ON boarding_pass.seat_type_id = purchase.seat_type_id
